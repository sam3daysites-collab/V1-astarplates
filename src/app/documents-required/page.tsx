...
export const metadata = buildMetadata({
  ...
  description:
    "Buy road legal UK number plates: what to upload, what we accept, what we reject and how fast we verify. Plain English, no legal waffle.",
  path: "/documents-required",
});

const idDocs = [
  { name: "UK driving licence", note: "Full or provisional, both sides." },
  { name: "Valid passport", note: "Photo page, in date." },
  { name: "Armed forces ID card", note: "Clear, in date." },
  { name: "Police warrant card", note: "Clear, in date." },
];

const entitlementDocs = [
  {
    name: "V5C — vehicle log book",
    note: "Most common. Page 1 with the registration and your name and address.",
  },
  {
    name: "V5C/2 — new keeper supplement",
    note: "Use this if you've just bought a vehicle and the V5C hasn't arrived yet.",
  },
  {
  ...
  },
  {
    ...
    note: "For a newly bought private registration.",
  },
  {
    name: "Hire or lease agreement",
    note: "Must clearly show your name and the vehicle registration.",
  },
  {
    name: "Trade insurance certificate",
    note: "Must clearly show your name and the vehicle registration.",
  },
];
        ...
        <div className="mx-auto max-w-4xl px-6 py-16">
          <header>
            ...
            <p className="mt-4 text-neutral-700">
              ...
              entitlement to the registration before pressing a road legal
              plate. Upload both at checkout. Most orders are verified in under
          ...
          <div className="mt-10 rounded-2xl border border-amber-200 bg-amber-50 p-6 text-sm text-amber-900">
            ...
            <p className="mt-2">
              ...
              not road legal and must not be fitted to a vehicle used on a
              public road.{" "}
              <Link
                href="/show-plates"
          ...
          <div className="mt-10 rounded-2xl border border-neutral-200 bg-white p-6 text-sm text-neutral-700">
            ...
            <p className="mt-2">
              We store ID and entitlement documents encrypted at rest. Registered
              number plate suppliers must keep verification records for a
              minimum of three years — we hold them for that period and no
              longer than is necessary. We never share your documents with
              third parties. All processing is under UK GDPR.
            </p>
          </div>
